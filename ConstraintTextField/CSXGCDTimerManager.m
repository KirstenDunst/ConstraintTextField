...
@implementation CSXGCDTimerManager

#pragma mark - Public Method

+ (CSXGCDTimerManager *)sharedInstance {
    static CSXGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[CSXGCDTimerManager alloc] init];
    });
